...
const ScandashDropdown = class {
  ...
  render() {
    var _a, _b, _c, _d;
    const iconChevron = index.getAssetPath(`assets/chevron.svg`);
    if (((_a = this.sanitizedOptions) === null || _a === void 0 ? void 0 : _a.length) === 0)
      return null;
    return (index.h("div", null, index.h("button", { role: "combobox", "aria-controls": `${this.id}-listbox`, "aria-expanded": this.isExpanded.toString(), "aria-haspopup": "listbox", "aria-labelledby": `${this.id}-label`, class: this.selectedOption ? undefined : 'empty', onClick: () => (this.isExpanded = !this.isExpanded), style: {
        height: `${this.itemSize}px`,
        fontSize: `${this.fontSize}px`,
      } }, ((_b = this.selectedOption) === null || _b === void 0 ? void 0 : _b.label) ? (index.h("strong", null, (_c = this.selectedOption) === null || _c === void 0 ? void 0 : _c.label)) : (index.h("span", null, this.placeholder || 'Select an option...')), index.h("img", { src: iconChevron, alt: "", "aria-hidden": "true", class: this.isExpanded ? 'rotate-180' : undefined, style: {
        height: `${this.itemSize}px`,
        width: `${this.itemSize}px`,
      } })), index.h("div", { id: `${this.id}-listbox`, class: this.isExpanded ? undefined : 'visually-hidden no-events', role: "listbox", "aria-labelledby": `${this.id}-label` }, (_d = this.sanitizedOptions) === null || _d === void 0 ? void 0 : _d.map((option, index$1) => {
      var _a, _b, _c;
      return (index.h("button", { key: index$1, class: option.disabled ? 'no-events' : undefined, role: "option", "aria-disabled": (_a = option.disabled) === null || _a === void 0 ? void 0 : _a.toString(), "aria-posinset": index$1 + 1, "aria-selected": (((_b = this.selectedOption) === null || _b === void 0 ? void 0 : _b.value) === option.value).toString(), "aria-setsize": this.sanitizedOptions.length, onClick: () => !(option === null || option === void 0 ? void 0 : option.disabled) && this.handleOptionClicked(option), onKeyDown: e => [
          'ArrowDown',
          'ArrowUp',
          'Escape',
          'Home',
          ...
          height: `${this.itemSize}px`,
          fontSize: `${this.fontSize}px`,
        } }, ((_c = this.selectedOption) === null || _c === void 0 ? void 0 : _c.value) === option.value ? (index.h("strong", null, option.label)) : (index.h("span", null, option.label))));
    }))));
  }
...
ScandashDropdown.style = scandashDropdownCss;

exports.scandash_dropdown = ScandashDropdown;
